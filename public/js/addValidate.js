// Add 1
const add1 = new Array(getById('name1') , getById('quantity1') , getById('price1') , getById('image1') , getById('name1_error') , getById('quantity1_error') , getById('price1_error') , getById('image1_error'))

// Add 2
const add2 = new Array(getById('name2') , getById('quantity2') , getById('price2') , getById('image2') , getById('name2_error') , getById('quantity2_error') , getById('price2_error') , getById('image2_error'))
...
addForm.addEventListener('submit' , e => {
    ...
    if(validateName(add1[0] , add1[4]) & validateQuantity(add1[1] , add1[5]) & validatePrice(add1[2] , add1[6]) & checkImage(add1[3] , add1[7]) & validateName(add2[0] , add2[4]) & validateQuantity(add2[1] , add2[5]) & validatePrice(add2[2] , add2[6]) & checkImage(add2[3] , add2[7])) {
        addForm.submit()
    }
